...
RUN apt-get update -y && apt-get install -y dpkg-dev cpp-10 gcc-10 g++-10 build-essential git curl cmake && apt-get clean && rm -f /var/lib/apt/lists/*_*
...
# Download ML models
RUN elixir priv/models/download.exs
